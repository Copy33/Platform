...
import com.joemerhej.androidweekview.MonthLoader.MonthChangeListener
import com.joemerhej.androidweekview.WeekViewUtil.daysBetween
import com.joemerhej.androidweekview.WeekViewUtil.getPassedMinutesInDay
import com.joemerhej.androidweekview.WeekViewUtil.isSameDay
import com.joemerhej.androidweekview.WeekViewUtil.today
...
class WeekView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : View(context, attrs, defStyleAttr)
{
    ...
    private val mGestureListener = object : GestureDetector.SimpleOnGestureListener()
    {
        ...
        override fun onSingleTapConfirmed(e: MotionEvent): Boolean
        {
            ...
            if(addEventClickListener != null && mNewEventRect != null && mNewEventRect!!.rectF != null && mNewEventRect!!.rectF!!.contains(x, y))
            {
        ...
        override fun onLongPress(e: MotionEvent)
        {
            ...
            // If the long press was on an event, then trigger the callback.
            ...
            // If the long press was on an empty space, then trigger the callback.
    ...
    var dateTimeInterpreter: DateTimeInterpreter = object : DateTimeInterpreter
    {
        ...
        {
            return normalDateFormat.format(date.time)
        }
    }
        set(value)
        {
            ...
            if(availableHeight >= lineHeight)
            {
                ...
                do
                {
                    ...
                    if(newEventIdentifier != event.id)
                        textLayout = StaticLayout(TextUtils.ellipsize(bob, mEventTextPaint, (availableLineCount * availableWidth).toFloat(), TextUtils.TruncateAt.END), mEventTextPaint,
                                (rect.right - originalLeft - (eventPadding * 2).toFloat()).toInt(), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0f, false)
...
//region interfaces
    ...
    {
        /**
         * Similar to [com.joemerhej.androidweekview.WeekView.EmptyViewClickListener] but with long press.
         *
